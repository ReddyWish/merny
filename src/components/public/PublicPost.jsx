...
function PublicPost() {
  const { id } = useParams()
  const requestedPublicPost = publicPostsArray.find(publicPost => publicPost._id === id)
  return (
    <div className="min-h-screen flex flex-col">
      <PublicHeader/>
      <main className="flex justify-center items-center h-fullw">
      <article className="w-full px-4 md:w-3/4 lg:w-1/2 mt-10">
        <div>
          <div className="flex items-center mb-6 space-x-4">
            ...
            <div className="space-y-1 font-medium dark:text-white">
              <p>{requestedPublicPost.username}</p>
        ...
        <div className="col-span-2 mt-6 md:mt-0">
          <div className="flex items-start mb-5">
            <div className="pr-4">
              <footer>
                <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">Published on: Before bible was written</p>
              </footer>
              <h4 className="text-xl font-bold text-gray-900 dark:text-white">{requestedPublicPost.title}</h4>
            </div>
          </div>
          <p className="mb-2 text-gray-500 dark:text-gray-400">{requestedPublicPost.content}</p>
        </div>
      </article>
      </main>
    </div>
